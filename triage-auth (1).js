...
(function(){
  ...
  // Si la URL trae ?acceso=publico, se omite la verificación de sesión por completo.
  // Pensado para el kiosko de autoregistro: cualquier paciente puede usarlo sin cuenta
  // al escanear el código QR, sin afectar la protección del resto del sistema.
  const params = new URLSearchParams(window.location.search);
  if(params.get('acceso') === 'publico'){
    return;
  }
